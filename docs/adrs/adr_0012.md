...
**Why Not Selected**: Query modifications change search semantics unpredictably and are difficult to debug.
...
**Why Not Selected**: Multiple queries add unacceptable latency to the search path.

### Option 3: Post-retrieval namespace weighting (Selected)
...
**Why Selected**: Best balance of simplicity, debuggability, and performance while maintaining clean separation of concerns.
