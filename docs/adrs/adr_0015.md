...
**Why Not Selected**: Unpredictable behavior and potential context overflow make this unsuitable for production use.
...
**Why Not Selected**: Memory count does not correlate well with token usage, leading to inconsistent behavior.

### Option 3: Token budget with truncation (Selected)
...
**Why Selected**: Provides the most consistent and predictable context management while maintaining access to full content via URN references.
